-- 这个文件是用来配置 Neovim 的插件的。它使用了 Lua 语言来描述插件的安装和配置。其中使用了一些插件，如 nvim-treesitter、swap-ternary.nvim、playground、nvim-treesitter-context、rainbow-delimiters.nvim 和 wildfire.nvim。每个插件都有不同的配置和功能，具体的实现逻辑可以在每个插件的文档中找到。这个文件是用来配置 Neovim 的插件的。它使用了 Lua 语言来描述插件的安装和配置。其中使用了一些插件，如 nvim-treesitter、swap-ternary.nvim、playground、nvim-treesitter-context、rainbow-delimiters.nvim 和 wildfire.nvim。每个插件都有不同的配置和功能，具体的实现逻辑可以在每个插件的文档中找到。
